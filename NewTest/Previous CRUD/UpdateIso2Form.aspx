<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateIso2Form.aspx.cs" Inherits="NewTest.UpdateIso2Form" %>
            ...
            $.ajax({
                ...
                success: function (response) {
                    $.each(response.d, function (i, item) {
                        $('#_Fld_Sitestyle_Iso639_2_Code').val(item._Fld_Sitestyle_Iso639_2_Code);
                    });
                },
                failure: function () {
