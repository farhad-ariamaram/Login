<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateIso3Form.aspx.cs" Inherits="NewTest.UpdateIso3Form" %>
            ...
            $.ajax({
                ...
                success: function (response) {
                    $.each(response.d, function (i, item) {
                        $('#_Fld_Sitestyle_Iso639_3_Code').val(item._Fld_Sitestyle_Iso639_3_Code);
                    });
                },
                failure: function () {
