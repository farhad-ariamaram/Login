<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateFontForm.aspx.cs" Inherits="NewTest.UpdateFontForm" %>
            ...
            <div id="Form" dir="rtl" class="col-lg-4 col-md-6 col-sm-12 col-12 text-center centered">
                <form class="form-group" action="#" method="post" id="myform">
                    <div class="form-group">
                        <label class="bg-dark w-100 text-white">افزودن فونت</label>
                    </div>
