<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Iso3Form.aspx.cs" Inherits="NewTest.Iso3Form" %>
    ...
    <script>
        ...
        function deleteitem(idd) {
            ...
            if (r == true) {
                ...
                $.ajax({
                    type: "POST",
                    url: "WebServices.aspx/deleteiso3",
        ...
        function updateitem(idd) {
            ...
            $.ajax({
                type: "POST",
                url: "WebServices.aspx/readIso639_3ById",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                data: JSON.stringify(data),
                success: function (response) {
                    $.each(response.d, function (i, item) {
                        $('#txtCode').val(item._Fld_Sitestyle_Iso639_3_Code);
                    });
                },
                failure: function () {
        ...
        function refreshdata() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    $.each(response.d, function (i, item) {
                        $('<tr>').html("<td>" + item._Fld_Sitestyle_Iso639_3_Code + "</td><td><a class='btn btn-primary' onclick='updateitem(" + item._Fld_Sitestyle_Iso639_3_Id + ")'>ویرایش</a><a class='btn btn-danger' onclick='deleteitem(" + item._Fld_Sitestyle_Iso639_3_Id + ")'>حذف</a></td>").appendTo('#table');
                    });
                },
                failure: function () {
                    alert("there is a error!");
        ...
        function updatesubmitdata() {
            ...
            var obj =
            {
                "_Fld_Sitestyle_Iso639_3_Id": id,
                "_Fld_Sitestyle_Iso639_3_Code": code,
            };

            $.ajax({
                type: "POST",
                url: "WebServices.aspx/updateiso3",
                contentType: "application/json",
                data: JSON.stringify({ obj: obj }),
                success: function (data) {
                    refreshdata();
