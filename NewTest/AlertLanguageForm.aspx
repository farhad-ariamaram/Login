<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlertLanguageForm.aspx.cs" Inherits="NewTest.AlertLanguageForm" %>
...
<head>
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "WebServices.aspx/readAlertDropdown",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                success: function (response) {
                    $.each(response.d, function (i, item) {
                        var optionRow = "<option value=" + item._Fld_Sitestyle_Alert_Id + ">" + item._Fld_Sitestyle_Alert_Title + "</option>";
                        $(optionRow).appendTo('#DropdownAlert');
                    });
                },
                failure: function () {
        ...
        function submitdata() {
            ...
            var alert = $("#DropdownAlert").val();
            var lang = $("#DropdownLanguage").val();
            var obj =
            {
                "_Fld_Sitestyle_AlertLanguage_Id": "0",
                "_Fld_Sitestyle_AlertLanguage_Text": text,
                "_Fld_Sitestyle_AlertLanguage_Title": title,
                "_Fld_Sitestyle_AlertLanguage_AlertId": alert,
                "_Fld_Sitestyle_AlertLanguage_LanguageId": lang
            };

            $.ajax({
                type: "POST",
                url: "WebServices.aspx/createAlertLanguage",
        ...
        function deleteitem(idd) {
            ...
            if (r == true) {
                ...
                $.ajax({
                    type: "POST",
                    url: "WebServices.aspx/deleteAlertLanguage",
                    contentType: "application/json;charset=utf-8",
                    dataType: "json",
        ...
        function updateitem(idd) {
            ...
            $.ajax({
                type: "POST",
                url: "WebServices.aspx/readAlertLanguageById",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                data: JSON.stringify(data),
                success: function (response) {
                    $.each(response.d, function (i, item) {
                        $('#txtText').val(item._Fld_Sitestyle_AlertLanguage_Text);
                        $('#txtTitle').val(item._Fld_Sitestyle_AlertLanguage_Title);
                        $("#DropdownAlert").val(item._Fld_Sitestyle_AlertLanguage_AlertId);
                        $("#DropdownLanguage").val(item._Fld_Sitestyle_AlertLanguage_LanguageId);
                    });
                },
                failure: function () {
                    alert("there is a error!");
        ...
        function refreshdata() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    $.each(response.d, function (i, item) {
                        $('<tr>').html("<td>" + item._Fld_Sitestyle_AlertLanguage_Text + "</td><td>" + item._Fld_Sitestyle_AlertLanguage_Title + "</td><td>" + item._Fld_Sitestyle_AlertLanguage_Alert + "</td><td>" + item._Fld_Sitestyle_AlertLanguage_Language + "</td><td><a class='btn btn-primary' onclick='updateitem(" + item._Fld_Sitestyle_AlertLanguage_Id + ")'>ویرایش</a><a class='btn btn-danger' onclick='deleteitem(" + item._Fld_Sitestyle_AlertLanguage_Id + ")'>حذف</a></td>").appendTo('#table');
                    });
                },
                failure: function () {
                    alert("there is a error!");
        ...
        function updatesubmitdata() {
            ...
            $.ajax({
                type: "POST",
                url: "WebServices.aspx/updateAlertLanguage",
                contentType: "application/json",
                data: JSON.stringify({ obj: obj }),
                success: function (data) {
                    refreshdata();
                ...
                <div id="Form" dir="rtl" class="col-lg-4 col-md-6 col-sm-12 col-12 text-center centered">
                    <form class="form-group" action="#" method="post" id="myform">
                        <div class="form-group">
                            <label class="bg-dark w-100 text-white">افزودن زبان اعلان</label>
                        </div>
                        ...
                        <div class="form-group form-inline">
                            <label class="labels" for="DropdownAlert">اعلان</label>
                            <select name="DropdownAlert" id="DropdownAlert" class="w-100">
                            </select>
                        </div>
                        <div class="form-group form-inline">
