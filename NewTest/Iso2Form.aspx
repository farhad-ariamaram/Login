<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Iso2Form.aspx.cs" Inherits="NewTest.Iso2Form" %>
...
<head>
    ...
    <script>
        ...
        function submitdata() {
            ...
            var obj =
            {
                "_Fld_Sitestyle_Iso639_2_Id": "0",
                "_Fld_Sitestyle_Iso639_2_Code": code,
            };

            $.ajax({
                type: "POST",
                url: "WebServices.aspx/createiso2",
        ...
        function deleteitem(idd) {
            ...
            if (r == true) {
                ...
                $.ajax({
                    type: "POST",
                    url: "WebServices.aspx/deleteiso2",
        ...
        function updateitem(idd) {
            ...
            $.ajax({
                type: "POST",
                url: "WebServices.aspx/readIso639_2ById",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                data: JSON.stringify(data),
                success: function (response) {
                    $.each(response.d, function (i, item) {
                        $('#txtCode').val(item._Fld_Sitestyle_Iso639_2_Code);
                    });
                },
                failure: function () {
        ...
        function refreshdata() {
            ...
            $.ajax({
                type: "POST",
                url: "WebServices.aspx/readIso639_2",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                success: function (response) {
                    $.each(response.d, function (i, item) {
                        $('<tr>').html("<td>" + item._Fld_Sitestyle_Iso639_2_Code + "</td><td><a class='btn btn-primary' onclick='updateitem(" + item._Fld_Sitestyle_Iso639_2_Id + ")'>ویرایش</a><a class='btn btn-danger' onclick='deleteitem(" + item._Fld_Sitestyle_Iso639_2_Id + ")'>حذف</a></td>").appendTo('#table');
                    });
                },
                failure: function () {
                    alert("there is a error!");
        ...
        function updatesubmitdata() {
            ...
            var obj =
            {
                "_Fld_Sitestyle_Iso639_2_Id": id,
                "_Fld_Sitestyle_Iso639_2_Code": code,
            };

            $.ajax({
                type: "POST",
                url: "WebServices.aspx/updateiso2",
                contentType: "application/json",
                data: JSON.stringify({ obj: obj }),
                success: function (data) {
                    refreshdata();
