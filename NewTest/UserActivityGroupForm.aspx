<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserActivityGroupForm.aspx.cs" Inherits="NewTest.UserActivityGroupForm" %>
...
<head>
    ...
    <script>
        ...
        function submitdata() {
            ...
            var obj =
            {
                "_Fld_Users_UsersActivityGroup_Id": "0",
                "_Fld_Users_UsersActivityGroup_Title": title
            };

            $.ajax({
                type: "POST",
                url: "WebServices.aspx/createUserActivityGroup",
        ...
        function deleteitem(idd) {
            ...
            if (r == true) {
                ...
                $.ajax({
                    type: "POST",
                    url: "WebServices.aspx/deleteUserActivityGroup",
        ...
        function updateitem(idd) {
            ...
            $.ajax({
                type: "POST",
                url: "WebServices.aspx/readUserActivityGroupById",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                data: JSON.stringify(data),
                success: function (response) {
                    $.each(response.d, function (i, item) {
                        $('#txtTitle').val(item._Fld_Users_UsersActivityGroup_Title);
                    });
                },
                failure: function () {
        ...
        function refreshdata() {
            ...
            $.ajax({
                type: "POST",
                url: "WebServices.aspx/readUserActivityGroup",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                success: function (response) {
                    $.each(response.d, function (i, item) {
                        $('<tr>').html("<td>" + item._Fld_Users_UsersActivityGroup_Title + "</td><td><a class='btn btn-primary' onclick='updateitem(" + item._Fld_Users_UsersActivityGroup_Id + ")'>ویرایش</a><a class='btn btn-danger' onclick='deleteitem(" + item._Fld_Users_UsersActivityGroup_Id + ")'>حذف</a></td>").appendTo('#table');
        ...
        function updatesubmitdata() {
            ...
            var obj =
            {
                "_Fld_Users_UsersActivityGroup_Id": id,
                "_Fld_Users_UsersActivityGroup_Title": title
            };

            $.ajax({
                type: "POST",
                url: "WebServices.aspx/updateUserActivityGroup",
                contentType: "application/json",
                data: JSON.stringify({ obj: obj }),
                success: function (data) {
                    refreshdata();
                ...
                <div id="Form" dir="rtl" class="col-lg-4 col-md-6 col-sm-12 col-12 text-center centered">
                    <form class="form-group" action="#" method="post" id="myform">
                        <div class="form-group">
                            <label class="bg-dark w-100 text-white">افزودن گروه کاربری جدید</label>
                        </div>
